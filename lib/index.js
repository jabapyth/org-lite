...
var write = exports.write = function(children, fname) {
  fs.writeFileSync(fname, serialize_all(children), {encoding: 'utf8'});
};

var read = exports.read = function(fname, options){
