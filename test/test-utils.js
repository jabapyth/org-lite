...
var expect = require('expect.js')
  ...
  , base = '../lib' + (process.env.EXPRESS_COV ? '-cov' : '')
  , org = require(base + '/utils');
...
describe('utils', function () {
  ...
  describe('starify', function(){
    describe('when given in/out files', function(){
      var files = fs.readdirSync(__dirname + '/data/starify');
    ...
    describe('when given bad input', function(){
      ...
      files.forEach(function(fname){
        ...
        it('should fail to parse ' + fname, function(){
          ...
          expect(parse).to.throwException(org.ParseError);
        });
      });
    });
  });
  ...
  describe('promote()', function(){
    describe('when given in/out files', function(){
      ...
      var place = path.join(__dirname, 'data', 'promote');
